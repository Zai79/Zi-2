// index.js — Unified: Miko (miko | smart | hybrid) + Qwen2.5-72B (Together)
...
// ===== Global Cooldown — ONLY ADDITION 1 =====
let GLOBAL_LAST = 0;
const GLOBAL_COOLDOWN_MS = 800; // 0.8s بين كل معالجة
...
قواعد صارمة:
- ردود قصيرة جدًا (سطر أو سطرين) تتحدثين العربية دائما والانجليزية  عندما يتكلم معك شخص بلغة الإنجليزي فقط ، ذكية، لاذعة بخفة، أنيمية النبرة.
...
const TOGETHER_MODEL = 'Qwen/Qwen2.5-72B-Instruct';
